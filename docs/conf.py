...
# -*- coding: utf-8 -*-
#
# phuzzy documentation build configuration file, created by
...
version = phuzzy.__version__
# The full version, including alpha/beta/rc tags.
release = phuzzy.__version__
...
latex_documents = [
    (master_doc, 'phuzzy.tex',
     u'phuzzy Documentation',
     u'Lepy', 'manual'),
]
